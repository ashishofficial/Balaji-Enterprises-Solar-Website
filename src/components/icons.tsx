...
export function WrenchIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M14.7 6.3a4 4 0 0 0 5.7 5.7l-9.6 9.6a2 2 0 1 1-2.8-2.8l9.6-9.6a4 4 0 0 0-2.9-2.9z" />
    </svg>
  );
}
...
export function LeafIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M11 20A7 7 0 0 1 4 13c0-3.5 2.5-6 6-7 4-1 6-1 9-1 0 3 0 5-1 9-1 3.5-3.5 6-7 6Z" />
      <path d="M2 22c4-2 8-7 10-12" />
    </svg>
  );
}
